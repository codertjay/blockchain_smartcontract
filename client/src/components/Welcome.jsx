...
const commonStyles = "min-h-[70px] sm:px-0 px-2 sm:min-w-[120px] flex justify-center items-center border-[0.5px] " +
...
const Welcome = () => {
    const {
        ...
        formData, handleChange, sendTransaction, isLoading, setIsLoading
                    ...
                    <div
                        ...
                        <div className="flex justify-between flex-col w-full h-full">
                            ...
                            <div>
                                ...
                                </p>   <p className="text-white font-semibold text-lgm mt-1">
                                Ethereum
                            </p>
                            </div>
                        </div>
